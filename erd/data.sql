...
insert into books(name,price,sale_price,intro,content,image,quantity,author_id,category_id)
values 
...
insert into users(address,birth_day, email,gender,name,phone,account_id) 
values("02-Thanh Sơn, Đà Nẵng","2000-12-10","a@gmail.com",1,"Nguyễn Văn A","0123456789",2);
